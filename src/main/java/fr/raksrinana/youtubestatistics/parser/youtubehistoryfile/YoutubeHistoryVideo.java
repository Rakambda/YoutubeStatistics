package fr.raksrinana.youtubestatistics.parser.youtubehistoryfile;
...
import fr.raksrinana.youtubestatistics.utils.URLUtils;
import fr.raksrinana.youtubestatistics.utils.json.ISO8601DateTimeDeserializer;
import fr.raksrinana.youtubestatistics.utils.json.URLDeserializer;
...
public class YoutubeHistoryVideo implements IYouTubeVideo{
	...
	public boolean equals(Object o){
		...
		if(!(o instanceof IYouTubeVideo)){
			return false;
		}
		IYouTubeVideo that = (IYouTubeVideo) o;
